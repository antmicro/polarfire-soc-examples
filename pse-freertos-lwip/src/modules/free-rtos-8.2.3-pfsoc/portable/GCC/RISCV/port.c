...
/* Scheduler includes. */
#include "../portable/GCC/RISCV/portmacro.h"
...
{
    if (mtime && mtimecmp) 
        *mtimecmp = *mtime + (configTICK_CLOCK_HZ / configTICK_RATE_HZ);
}
/*-----------------------------------------------------------*/
...
StackType_t *pxPortInitialiseStack( StackType_t *pxTopOfStack, TaskFunction_t pxCode, void *pvParameters )
{
	...
	pxTopOfStack--;
	*pxTopOfStack = (portSTACK_TYPE)0;   			/* Normal context switch */
	pxTopOfStack--;
	*pxTopOfStack = (portSTACK_TYPE)0;   			/* Scratch register */
	pxTopOfStack--;
