 ...
 * implemented for the G5 SOC. This also covers the subset implemented for the
 * FU540 on the Aloe board with the provisio that many of the registers will not
 * be present on that device.
 *
...
#ifndef MSS_MAC_REGISTERS
#define MSS_MAC_REGISTERS
