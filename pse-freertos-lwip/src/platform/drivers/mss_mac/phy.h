...
#define PHYCR_TX_FIFO_DEPTH				0xC000
#define PHYCR_RX_FIFO_DEPTH				0x3000
#define PHYCR_SGMII_EN					0x0800
#define PHYCR_FORCE_LINK_GOOD    		0x0400
#define PHYCR_POWER_SAVE_MODE			0x0300
#define PHYCR_DEEP_POWER_DOWN_EN		0x0080
#define PHYCR_MDI_CROSSOVER				0x0060
#define PHYCR_DISABLE_CLK_125			0x0010
#define PHYCR_STANDBY_MODE     			0x0004
#define PHYCR_LINE_DRIVER_INV_EN		0x0002
#define PHYCR_DISABLE_JABBER			0x0001

/* TI DP83867 Control Register */

#define CTRL_SW_RESET					0x8000
#define CTRL_SW_RESTART					0x4000

/* TI DP83867 SGMII Control Register 1 */

#define SGMII_TYPE_6_WIRE				0x4000

/* Different PHY MDIO addresses for our current designs */

#define PHY_VSC8541_MDIO_ADDR 0  /* Aloe board PHY */
#define PHY_VSC8575_MDIO_ADDR 4  /* HW emulation Peripheral Daughter Board PHY */
#define PHY_DP83867_MDIO_ADDR 3  /* HW emulation native PHY */
#define PHY_NULL_MDIO_ADDR    0  /* No PHY here actually... */
#define SGMII_MDIO_ADDR       16 /* Internal PHY in HW emulation SGMII to GMII core */
...
void MSS_MAC_VSC8575_phy_init(/* mss_mac_instance_t */ void *v_this_mac, uint8_t phy_addr);
#endif
...
#if MSS_MAC_USE_PHY_VSC8575
void MSS_MAC_VSC8575_phy_set_link_speed(/* mss_mac_instance_t */ void *v_this_mac, uint32_t speed_duplex_select);
#endif
...
#if MSS_MAC_USE_PHY_VSC8575
void MSS_MAC_VSC8575_phy_autonegotiate(/* mss_mac_instance_t */ void *v_this_mac);
#endif
