...
C_SRCS += \
../src/application/web-server/http_server.c \
../src/application/web-server/http_structure_helpers.c \
../src/application/web-server/httpserver-netconn.c \
../src/application/web-server/route_handlers.c 

OBJS += \
./src/application/web-server/http_server.o \
./src/application/web-server/http_structure_helpers.o \
./src/application/web-server/httpserver-netconn.o \
./src/application/web-server/route_handlers.o 

C_DEPS += \
./src/application/web-server/http_server.d \
./src/application/web-server/http_structure_helpers.d \
./src/application/web-server/httpserver-netconn.d \
./src/application/web-server/route_handlers.d 


# Each subdirectory must supply rules for building sources it contributes
src/application/web-server/%.o: ../src/application/web-server/%.c
	@echo 'Building file: $<'
