...
C_SRCS += \
../src/application/utils/c_template.c \
../src/application/utils/common_functions.c \
../src/application/utils/configure_network.c 

OBJS += \
./src/application/utils/c_template.o \
./src/application/utils/common_functions.o \
./src/application/utils/configure_network.o 

C_DEPS += \
./src/application/utils/c_template.d \
./src/application/utils/common_functions.d \
./src/application/utils/configure_network.d 


# Each subdirectory must supply rules for building sources it contributes
src/application/utils/%.o: ../src/application/utils/%.c
	@echo 'Building file: $<'
