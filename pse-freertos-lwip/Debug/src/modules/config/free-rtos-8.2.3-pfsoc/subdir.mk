...
C_SRCS += \
../src/modules/config/free-rtos-8.2.3-pfsoc/free_rtos_implementations.c 

OBJS += \
./src/modules/config/free-rtos-8.2.3-pfsoc/free_rtos_implementations.o 

C_DEPS += \
./src/modules/config/free-rtos-8.2.3-pfsoc/free_rtos_implementations.d 


# Each subdirectory must supply rules for building sources it contributes
src/modules/config/free-rtos-8.2.3-pfsoc/%.o: ../src/modules/config/free-rtos-8.2.3-pfsoc/%.c
	@echo 'Building file: $<'
