...
C_SRCS += \
../src/modules/config/printf-4.0.0/use_mss_uart.c 

OBJS += \
./src/modules/config/printf-4.0.0/use_mss_uart.o 

C_DEPS += \
./src/modules/config/printf-4.0.0/use_mss_uart.d 


# Each subdirectory must supply rules for building sources it contributes
src/modules/config/printf-4.0.0/%.o: ../src/modules/config/printf-4.0.0/%.c
	@echo 'Building file: $<'
