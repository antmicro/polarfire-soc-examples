...
C_SRCS += \
../src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/port.c 

S_UPPER_SRCS += \
../src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/portasm.S 

OBJS += \
./src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/port.o \
./src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/portasm.o 

S_UPPER_DEPS += \
./src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/portasm.d 

C_DEPS += \
./src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/port.d 


# Each subdirectory must supply rules for building sources it contributes
src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/%.o: ../src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/%.c
	@echo 'Building file: $<'
...
src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/%.o: ../src/modules/free-rtos-8.2.3-pfsoc/portable/GCC/RISCV/%.S
	@echo 'Building file: $<'
	@echo 'Invoking: GNU RISC-V Cross Assembler'
	riscv64-unknown-elf-gcc -march=rv64gc -mabi=lp64d -mcmodel=medlow -msmall-data-limit=0 -mstrict-align -mno-save-restore -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -x assembler-with-cpp -I"../src/application/" -I"../src/modules" -I"../src/platform" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
