...
C_SRCS += \
../src/modules/lwip-2.0.0-wip-port-freertos-pfsoc/netif/m2sxxx_ethernetif.c 

OBJS += \
./src/modules/lwip-2.0.0-wip-port-freertos-pfsoc/netif/m2sxxx_ethernetif.o 

C_DEPS += \
./src/modules/lwip-2.0.0-wip-port-freertos-pfsoc/netif/m2sxxx_ethernetif.d 


# Each subdirectory must supply rules for building sources it contributes
src/modules/lwip-2.0.0-wip-port-freertos-pfsoc/netif/%.o: ../src/modules/lwip-2.0.0-wip-port-freertos-pfsoc/netif/%.c
	@echo 'Building file: $<'
