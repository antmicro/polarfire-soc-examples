...
C_SRCS += \
../src/modules/lwip-2.0.0-wip/ping/ping.c 

OBJS += \
./src/modules/lwip-2.0.0-wip/ping/ping.o 

C_DEPS += \
./src/modules/lwip-2.0.0-wip/ping/ping.d 


# Each subdirectory must supply rules for building sources it contributes
src/modules/lwip-2.0.0-wip/ping/%.o: ../src/modules/lwip-2.0.0-wip/ping/%.c
	@echo 'Building file: $<'
